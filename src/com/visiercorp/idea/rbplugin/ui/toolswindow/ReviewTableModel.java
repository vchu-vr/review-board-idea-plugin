...
package com.visiercorp.idea.rbplugin.ui.toolswindow;
...
public class ReviewTableModel extends AbstractTableModel {
    ...
    public String getStatusAt(int rowIndex) {
        return reviews.get(rowIndex).status;
    }

    public int getIssueOpenCountAt(int rowIndex) {
        return reviews.get(rowIndex).issueOpenCount;
    }
