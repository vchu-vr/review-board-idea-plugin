...
import com.visiercorp.idea.rbplugin.ui.controls.MultiValueAutoComplete;
    ...
    private void createUIComponents() {
        ...
        targetGroupTextBox = MultiValueAutoComplete.create(
                project, new MultiValueAutoComplete.DataProvider() {
                    ...
                    public List<String> getValues(String prefix) {
                        try {
                            RBGroupList groupList = ReviewDataProvider.getInstance(project).groups(prefix);
                            List<String> groups = new ArrayList<>();
                            for (RBGroupList.Group group : groupList.groups) {
